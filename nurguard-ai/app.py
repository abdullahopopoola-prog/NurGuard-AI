...
with st.sidebar:
    ...
    **NurGuard AI** is a working prototype designed to secure digital evidence at the moment of collection. 
    It generates immutable cryptographic fingerprints (SHA-256) and tracks handlers over an offline-first SQLite database.
...
with tab1:
    ...
    st.write("Upload a digital evidence file (CCTV log, message export, log file) and secure it with an immutable hash.")
